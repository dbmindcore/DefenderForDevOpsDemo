...
public class SecretsInCode {
    ...
    String crypto = "aW{**7]K&E4,`}$G{!q;FjH`/]cS_@";

    String pwd = "postgres";

    String highCryptoEntropy = "HbjZ!+{c]Y5!kNzB+-p^A6bCt(zNtf=V";

    int x = 33;

    String base64 = "VGhpcyBxdWVyeSB3YXMgc2VydmVkIGJ5IHRoZSBSSVBFIERhdGFiYXNlIFF1ZXJ5IFNlcnZpY2UgdmVyc2lvbiAxLjk1LjEgKEJMQUFSS09QKQo=";

    String secret = "SKSLKSLKMSKMMK`\"MSLKXLsssa2d7h20387hd8cb2b$'^@*(@bcebw8bc8b28ebcb2ssssbe2b";

    public void echo(String credential) {
